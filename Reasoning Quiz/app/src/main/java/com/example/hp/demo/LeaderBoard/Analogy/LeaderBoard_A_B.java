...
import com.example.hp.demo.Adapter.LeaderBoardSec4B;
...
public class LeaderBoard_A_B extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leader_board__a__b);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec4B(this, new ArrayList<UserModel>());  // x
