...
import com.example.hp.demo.Adapter.LeaderBoardSec6E;
import com.example.hp.demo.Adapter.LeaderBoardSec6E;
...
public class LeaderBoard_NS_E extends AppCompatActivity {
    ...
    private LeaderBoardSec6E leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__ns__e);
        mUsersRecyclerView=(RecyclerView)findViewById(R.id.recycler_view_usersNS_E);
        setAuthInstance();
        setUsersDatabase();
        setUserRecyclerView();
        setUsersKeyList();
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec6E(this, new ArrayList<UserModel>());  // x
