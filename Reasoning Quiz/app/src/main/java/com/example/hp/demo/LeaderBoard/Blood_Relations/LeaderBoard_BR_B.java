package com.example.hp.demo.LeaderBoard.Blood_Relations;
...
public class LeaderBoard_BR_B extends AppCompatActivity {
    ...
    private LeaderBoardSec1B leaderBoardAdapterSec1;  // X1
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__br__b);
        mUsersRecyclerView=(RecyclerView)findViewById(R.id.recycler_view_users1B);
        setAuthInstance();
        setUsersDatabase();
        setUserRecyclerView();
        setUsersKeyList();
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec1B(this, new ArrayList<UserModel>());  // x
