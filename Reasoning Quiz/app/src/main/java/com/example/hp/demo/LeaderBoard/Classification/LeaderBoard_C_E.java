...
import com.example.hp.demo.Adapter.LeaderBoardSec11E;
...
public class LeaderBoard_C_E extends AppCompatActivity {
    ...
    private LeaderBoardSec11E leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__c__e);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec11E(this, new ArrayList<UserModel>());
