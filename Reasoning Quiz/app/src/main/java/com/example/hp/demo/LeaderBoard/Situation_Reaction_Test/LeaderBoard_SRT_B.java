package com.example.hp.demo.LeaderBoard.Situation_Reaction_Test;
...
import com.example.hp.demo.Adapter.LeaderBoardSec9B;
...
public class LeaderBoard_SRT_B extends AppCompatActivity {
    ...
    private LeaderBoardSec9B leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__srt__b);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec9B(this, new ArrayList<UserModel>());  // x
