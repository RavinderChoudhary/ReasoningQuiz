...
public class Main2ActivitySec8 extends AppCompatActivity {

    List<QuestionNum_Ana> quesList1;   // x
    public int score=0;
    int ctr1=1;
    QuestionNum_Ana currentQ1;   //x
    ...
    public ArrayList<String> wrongQuestListNum_Ana = new ArrayList<String>();   // x 3
    public ArrayList<String> selectedAnsNum_Ana = new ArrayList<String>();
    public ArrayList<String> actualAnswerNum_Ana = new ArrayList<String>();
    int number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2_sec8);
        ...
        final Main2ActivitySec8.CounterClass timer = new Main2ActivitySec8.CounterClass(600000, 1000);  //x
        timer.start();
        quesList1=db.getAllQuestions8(tableName,catName); //x
        for(int i=0;i<11;i++){
            while(true){
        ...
        butNext1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentQ1.getANSWER8().equals(answer.getText())) {  // compare database answer to current answer
                    score++;    // inc score
                }
                else
                {
                    wrongQuestListNum_Ana.add(number, currentQ1.getQUESTION8());   // add current wrong question   x 3
                    selectedAnsNum_Ana.add(number, answer.getText().toString());   // add current selected answer
                    actualAnswerNum_Ana.add(number, currentQ1.getANSWER8());    // add current correct answer
                    number++;
                }
    ...
    public void showResult(){
        Intent intent = new Intent(Main2ActivitySec8.this, ResultActivity.class);
        Bundle b = new Bundle();  // creating the object of bundle class
        b.putInt("scoreNum_Ana", score);//Your score       x
        b.putString("section",tableName);//Your table name
        b.putString("category",catName);//Your category name
        intent.putStringArrayListExtra("wrongQuestions", wrongQuestListNum_Ana);   // string array list  x 3
        intent.putStringArrayListExtra("selectedAnswer", selectedAnsNum_Ana);
        intent.putStringArrayListExtra("actualAnswer", actualAnswerNum_Ana);
    ...
    private void setQuestionView(){
        txtQuestion1.setText(currentQ1.getQUESTION8());   // set question
        rda1.setText(currentQ1.getOPTA8());
        rdb1.setText(currentQ1.getOPTB8());             // set options
        rdc1.setText(currentQ1.getOPTC8());
        rdd1.setText(currentQ1.getOPTD8());
        if(ctr1<10)
