...
public class LeaderBoard_NS_B extends AppCompatActivity {
    ...
    private LeaderBoardSec6B leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__ns__b);
        mUsersRecyclerView=(RecyclerView)findViewById(R.id.recycler_view_usersNS_B);
        setAuthInstance();
        setUsersDatabase();
        setUserRecyclerView();
        setUsersKeyList();
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec6B(this, new ArrayList<UserModel>());  // x
