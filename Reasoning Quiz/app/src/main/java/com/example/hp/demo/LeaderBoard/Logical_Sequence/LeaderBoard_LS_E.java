...
import com.example.hp.demo.Adapter.LeaderBoardSec7E;
...
public class LeaderBoard_LS_E extends AppCompatActivity {
    ...
    private LeaderBoardSec7E leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__ls__e);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec7E(this, new ArrayList<UserModel>());  // x
