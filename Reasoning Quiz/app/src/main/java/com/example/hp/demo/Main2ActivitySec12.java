...
public class Main2ActivitySec12 extends AppCompatActivity {

    List<QuestionEssential_Part> quesList1;   // x
    public int score=0;
    int ctr1=1;
    QuestionEssential_Part currentQ1;   //x
    ...
    public ArrayList<String> wrongQuestListEssential_Part = new ArrayList<String>();   // x 3
    public ArrayList<String> selectedAnsEssential_Part = new ArrayList<String>();
    public ArrayList<String> actualAnswerEssential_Part = new ArrayList<String>();
    int number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2_sec12);
        ...
        final Main2ActivitySec12.CounterClass timer = new Main2ActivitySec12.CounterClass(600000, 1000);  //
        timer.start();
        quesList1=db.getAllQuestions12(tableName,catName); //x
        for(int i=0;i<11;i++){
            while(true){
        ...
        butNext1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentQ1.getANSWER12().equals(answer.getText())) {  // compare database answer to current answer
                    score++;    // inc score
                }
                else
                {
                    wrongQuestListEssential_Part.add(number, currentQ1.getQUESTION12());   // add current wrong question   x 3
                    selectedAnsEssential_Part.add(number, answer.getText().toString());   // add current selected answer
                    actualAnswerEssential_Part.add(number, currentQ1.getANSWER12());    // add current correct answer
                    number++;
                }
    ...
    public void showResult(){
        Intent intent = new Intent(Main2ActivitySec12.this, ResultActivity.class);
        Bundle b = new Bundle();  // creating the object of bundle class
        b.putInt("scoreEssential_Part", score);//Your score       x
        b.putString("section",tableName);//Your table name
        b.putString("category",catName);//Your category name
        intent.putStringArrayListExtra("wrongQuestions", wrongQuestListEssential_Part);   // string array list  x 3
        intent.putStringArrayListExtra("selectedAnswer", selectedAnsEssential_Part);
        intent.putStringArrayListExtra("actualAnswer", actualAnswerEssential_Part);
    ...
    private void setQuestionView(){
        txtQuestion1.setText(currentQ1.getQUESTION12());   // set question
        rda1.setText(currentQ1.getOPTA12());
        rdb1.setText(currentQ1.getOPTB12());             // set options
        rdc1.setText(currentQ1.getOPTC12());
        rdd1.setText(currentQ1.getOPTD12());
        if(ctr1<10)
