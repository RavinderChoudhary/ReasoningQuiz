...
import com.example.hp.demo.Adapter.LeaderBoardSec7B;
...
public class LeaderBoard_LS_B extends AppCompatActivity {
    ...
    private LeaderBoardSec7B leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__ls__b);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec7B(this, new ArrayList<UserModel>());  // x
