package com.example.hp.demo.LeaderBoard.Verification_of_Truth;
...
import com.example.hp.demo.Adapter.LeaderBoardSec10B;
...
public class LeaderBoard_VT_B extends AppCompatActivity {
    ...
    private LeaderBoardSec10B leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__vt__b);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec10B(this, new ArrayList<UserModel>());  // x
