...
public class LeaderBoardSec1B extends RecyclerView.Adapter<LeaderBoardSec1B.ViewHolderUsers> {
    ...
    public LeaderBoardSec1B(Context context, List<UserModel> fireUsers) {  // x
        mUsers = fireUsers;
        mContext = context;
    ...
    public class ViewHolderUsers extends RecyclerView.ViewHolder  {
        ...
        public ViewHolderUsers(Context context, View itemView) {
            ...
            scoreBlood_rel = (TextView) itemView.findViewById(R.id.score);
