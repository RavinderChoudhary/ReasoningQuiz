package com.example.hp.demo.LeaderBoard.Analogy;
...
import com.example.hp.demo.Adapter.LeaderBoardSec4E;
...
public class LeaderBoard_A_E extends AppCompatActivity {
    ...
    private LeaderBoardSec4E leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__a__e);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec4E(this, new ArrayList<UserModel>());
