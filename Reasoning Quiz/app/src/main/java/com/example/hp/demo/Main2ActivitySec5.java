...
public class Main2ActivitySec5 extends AppCompatActivity {

    List<QuestionAlp_Test> quesList1;   // x
    public int score=0;
    int ctr1=1;
    QuestionAlp_Test currentQ1;   //x
    ...
    public ArrayList<String> wrongQuestListAlp_Test = new ArrayList<String>();   // x 3
    public ArrayList<String> selectedAnsAlp_Test = new ArrayList<String>();
    public ArrayList<String> actualAnswerAlp_Test = new ArrayList<String>();
    int number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2_sec5);
        ...
        final Main2ActivitySec5.CounterClass timer = new Main2ActivitySec5.CounterClass(600000, 1000);  //
        timer.start();
        quesList1=db.getAllQuestions5(tableName,catName); //x
        for(int i=0;i<11;i++){
            while(true){
        ...
        butNext1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentQ1.getANSWER5().equals(answer.getText())) {  // compare database answer to current answer
                    score++;    // inc score
                }
                else
                {
                    wrongQuestListAlp_Test.add(number, currentQ1.getQUESTION5());   // add current wrong question   x 3
                    selectedAnsAlp_Test.add(number, answer.getText().toString());   // add current selected answer
                    actualAnswerAlp_Test.add(number, currentQ1.getANSWER5());    // add current correct answer
                    number++;
                }
    ...
    public void showResult(){
        Intent intent = new Intent(Main2ActivitySec5.this, ResultActivity.class);
        Bundle b = new Bundle();  // creating the object of bundle class
        b.putInt("scoreAlp_Test", score);//Your score       x
        b.putString("section",tableName);//Your table name
        b.putString("category",catName);//Your category name
        intent.putStringArrayListExtra("wrongQuestions", wrongQuestListAlp_Test);   // string array list  x 3
        intent.putStringArrayListExtra("selectedAnswer", selectedAnsAlp_Test);
        intent.putStringArrayListExtra("actualAnswer", actualAnswerAlp_Test);
    ...
    private void setQuestionView(){
        txtQuestion1.setText(currentQ1.getQUESTION5());   // set question
        rda1.setText(currentQ1.getOPTA5());
        rdb1.setText(currentQ1.getOPTB5());             // set options
        rdc1.setText(currentQ1.getOPTC5());
        rdd1.setText(currentQ1.getOPTD5());
        if(ctr1<10)
