package com.example.hp.demo.LeaderBoard.Classification;
...
import com.example.hp.demo.Adapter.LeaderBoardSec11B;
import com.example.hp.demo.Adapter.LeaderBoardSec11B;
...
public class LeaderBoard_C_B extends AppCompatActivity {
    ...
    private LeaderBoardSec11B leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__c__b);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec11B(this, new ArrayList<UserModel>());  // x
