...
import com.example.hp.demo.Adapter.LeaderBoardSec12E;
...
public class LeaderBoard_EP_E extends AppCompatActivity {
    ...
    private LeaderBoardSec12E leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__ep__e);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec12E(this, new ArrayList<UserModel>());
