...
public class Main2ActivityFinal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer.start();
        quesList1=db.getAllQuestions0(tableName);
        for(int i=0;i<11;i++){
            while(true){
        ...
        butNext1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentQ1.getANSWER0().equals(answer.getText())) {
                    score++;
                    //Log.d("score", "Your score" + score1);
                }
                else
                {
                    wrongQuestListRandom.add(number, currentQ1.getQUESTION0());
                    selectedAnsRandom.add(number, answer.getText().toString());
                    actualAnswerRandom.add(number, currentQ1.getANSWER0());
                    number++;
                }
                grp.clearCheck();
                butNext1.setEnabled(false);
    ...
    private void setQuestionView(){
        txtQuestion1.setText(currentQ1.getQUESTION0());
        rda1.setText(currentQ1.getOPTA0());
        rdb1.setText(currentQ1.getOPTB0());
        rdc1.setText(currentQ1.getOPTC0());
        rdd1.setText(currentQ1.getOPTD0());
        if(ctr1<10)
