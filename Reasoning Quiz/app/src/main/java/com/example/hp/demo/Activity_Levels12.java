...
public class Activity_Levels12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__levels12);
        setTitle("Essential Part Levels");  //x
        ...
        beginner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(getApplicationContext(),Main2ActivitySec12.class);
