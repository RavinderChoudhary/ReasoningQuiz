...
public class Main2ActivitySec6 extends AppCompatActivity {

    List<QuestionNumber_Series> quesList1;   // x
    public int score=0;
    int ctr1=1;
    QuestionNumber_Series currentQ1;   //x
    ...
    public ArrayList<String> wrongQuestListNumber_Series = new ArrayList<String>();   // x 3
    public ArrayList<String> selectedAnsNumber_Series = new ArrayList<String>();
    public ArrayList<String> actualAnswerNumber_Series = new ArrayList<String>();
    int number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2_sec6);
        ...
        final Main2ActivitySec6.CounterClass timer = new Main2ActivitySec6.CounterClass(600000, 1000);  //
        timer.start();
        quesList1=db.getAllQuestions6(tableName,catName); //x
        for(int i=0;i<11;i++){
            while(true){
        ...
        butNext1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentQ1.getANSWER6().equals(answer.getText())) {  // compare database answer to current answer
                    score++;    // inc score
                }
                else
                {
                    wrongQuestListNumber_Series.add(number, currentQ1.getQUESTION6());   // add current wrong question   x 3
                    selectedAnsNumber_Series.add(number, answer.getText().toString());   // add current selected answer
                    actualAnswerNumber_Series.add(number, currentQ1.getANSWER6());    // add current correct answer
                    number++;
                }
    ...
    public void showResult(){
        Intent intent = new Intent(Main2ActivitySec6.this, ResultActivity.class);
        Bundle b = new Bundle();  // creating the object of bundle class
        b.putInt("scoreNumber_Series", score);//Your score       x
        b.putString("section",tableName);//Your table name
        b.putString("category",catName);//Your category name
        intent.putStringArrayListExtra("wrongQuestions", wrongQuestListNumber_Series);   // string array list  x 3
        intent.putStringArrayListExtra("selectedAnswer", selectedAnsNumber_Series);
        intent.putStringArrayListExtra("actualAnswer", actualAnswerNumber_Series);
    ...
    private void setQuestionView(){
        txtQuestion1.setText(currentQ1.getQUESTION6());   // set question
        rda1.setText(currentQ1.getOPTA6());
        rdb1.setText(currentQ1.getOPTB6());             // set options
        rdc1.setText(currentQ1.getOPTC6());
        rdd1.setText(currentQ1.getOPTD6());
        if(ctr1<10)
