...
import com.example.hp.demo.Adapter.LeaderBoardSec4I;
...
public class LeaderBoard_A_I extends AppCompatActivity {
    ...
    private LeaderBoardSec4I leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__a__i);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec4I(this, new ArrayList<UserModel>());
