...
import com.example.hp.demo.Adapter.LeaderBoardSec12I;
...
public class LeaderBoard_EP_I extends AppCompatActivity {
    ...
    private LeaderBoardSec12I leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__ep__i);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec12I(this, new ArrayList<UserModel>());
