...
import com.example.hp.demo.Adapter.LeaderBoardSec5E;
...
public class LeaderBoard_AT_E extends AppCompatActivity {
    ...
    private LeaderBoardSec5E leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__at__e);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec5E(this, new ArrayList<UserModel>());  // x
