...
public class LeaderBoard_BR_E extends AppCompatActivity {
    ...
    private LeaderBoardSec1E leaderBoardAdapterSec1; // x
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__br__e);

        mUsersRecyclerView=(RecyclerView)findViewById(R.id.recycler_view_users1E);
        setAuthInstance();
        setUsersDatabase();
        setUserRecyclerView();
        setUsersKeyList();
