package com.example.hp.demo.LeaderBoard.Alphabet_Test;
...
import com.example.hp.demo.Adapter.LeaderBoardSec5B;
import com.example.hp.demo.Adapter.LeaderBoardSec5I;
...
public class LeaderBoard_AT_I extends AppCompatActivity {
    ...
    private LeaderBoardSec5I leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__at__i);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec5I(this, new ArrayList<UserModel>());  // x
