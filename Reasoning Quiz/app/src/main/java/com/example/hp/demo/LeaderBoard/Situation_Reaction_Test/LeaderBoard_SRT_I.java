...
import com.example.hp.demo.Adapter.LeaderBoardSec9I;
...
public class LeaderBoard_SRT_I extends AppCompatActivity {
    ...
    private LeaderBoardSec9I leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__srt__i);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec9I(this, new ArrayList<UserModel>());
