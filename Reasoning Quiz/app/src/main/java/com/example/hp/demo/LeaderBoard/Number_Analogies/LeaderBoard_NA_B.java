package com.example.hp.demo.LeaderBoard.Number_Analogies;
...
import com.example.hp.demo.Adapter.LeaderBoardSec8B;
...
public class LeaderBoard_NA_B extends AppCompatActivity {
    ...
    private LeaderBoardSec8B leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__na__b);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec8B(this, new ArrayList<UserModel>());  // x
