...
import com.example.hp.demo.Adapter.LeaderBoardSec9E;
...
public class LeaderBoard_SRT_E extends AppCompatActivity {
    ...
    private LeaderBoardSec9E leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__srt__e);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec9E(this, new ArrayList<UserModel>());
