...
public class Activity_Levels10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__levels10);
        setTitle("Verification of Truth of the Statement Levels");  //x
        ...
        beginner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(getApplicationContext(),Main2ActivitySec10.class);
