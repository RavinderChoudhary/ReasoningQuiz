...
public class Activity_Levels11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__levels11);
        setTitle("Classification Levels");  //x
        ...
        beginner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(getApplicationContext(),Main2ActivitySec11.class);
