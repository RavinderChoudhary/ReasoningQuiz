...
import com.example.hp.demo.Adapter.LeaderBoardSec8I;
...
public class LeaderBoard_NA_I extends AppCompatActivity {
    ...
    private LeaderBoardSec8I leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__na__i);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec8I(this, new ArrayList<UserModel>());
