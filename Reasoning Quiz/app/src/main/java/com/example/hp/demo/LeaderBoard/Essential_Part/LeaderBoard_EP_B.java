package com.example.hp.demo.LeaderBoard.Essential_Part;
...
import com.example.hp.demo.Adapter.LeaderBoardSec12B;
...
public class LeaderBoard_EP_B extends AppCompatActivity {
    ...
    private LeaderBoardSec12B leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__ep__b);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec12B(this, new ArrayList<UserModel>());  // x
