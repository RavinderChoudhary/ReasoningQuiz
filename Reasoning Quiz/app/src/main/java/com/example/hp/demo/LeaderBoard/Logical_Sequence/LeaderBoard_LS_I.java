package com.example.hp.demo.LeaderBoard.Logical_Sequence;
...
import com.example.hp.demo.Adapter.LeaderBoardSec7I;
...
public class LeaderBoard_LS_I extends AppCompatActivity {
    ...
    private LeaderBoardSec7I leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__ls__i);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec7I(this, new ArrayList<UserModel>());  // x
