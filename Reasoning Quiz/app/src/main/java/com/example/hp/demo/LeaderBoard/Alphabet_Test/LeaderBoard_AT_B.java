...
public class LeaderBoard_AT_B extends AppCompatActivity {
    ...
    private LeaderBoardSec5B leaderBoardAdapterSec1;  // X1
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__at__b);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec5B(this, new ArrayList<UserModel>());  // x
