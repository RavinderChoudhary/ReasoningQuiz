...
public class Activity_Levels5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__levels5);
        setTitle("Alphabet Test Levels");  //x
        ...
        beginner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i= new Intent(getApplicationContext(),Main2ActivitySec5.class);
