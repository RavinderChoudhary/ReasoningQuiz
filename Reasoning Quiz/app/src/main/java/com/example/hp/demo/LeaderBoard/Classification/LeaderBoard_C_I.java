...
import com.example.hp.demo.Adapter.LeaderBoardSec11I;
...
public class LeaderBoard_C_I extends AppCompatActivity {
    ...
    private LeaderBoardSec11I leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__c__i);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec11I(this, new ArrayList<UserModel>());
