...
import com.example.hp.demo.Adapter.LeaderBoardSec10E;
...
public class LeaderBoard_VT_E extends AppCompatActivity {
    ...
    private LeaderBoardSec10E leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__vt__e);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec10E(this, new ArrayList<UserModel>());
