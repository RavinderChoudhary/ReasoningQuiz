...
import com.example.hp.demo.Adapter.LeaderBoardSec8E;
...
public class LeaderBoard_NA_E extends AppCompatActivity {
    ...
    private LeaderBoardSec8E leaderBoardAdapterSec1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board__na__e);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec8E(this, new ArrayList<UserModel>());
